...
image::examples/tuto-mona1.png[mona1,400,400]
...
image::examples/tuto-mona5.png[mona5,400,400]

Hit `apply`:

image::examples/tuto-mona6.png[mona6,400,400]
